...
// ==================================================================
// INICIO DE CAMBIOS: Importamos la función para resetear la contraseña
// ==================================================================
import { getAuth, signInWithEmailAndPassword, GoogleAuthProvider, signInWithPopup, sendPasswordResetEmail } from 'firebase/auth';
// ==================================================================
// FIN DE CAMBIOS
// ==================================================================
import { doc, getDoc, setDoc } from 'firebase/firestore'; // Usamos setDoc para el registro con Google
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ==================================================================
      // INICIO DE CAMBIOS: Mensajes de error más específicos
      // ==================================================================
      if (err.code === 'auth/user-not-found' || err.code === 'auth/invalid-credential' || err.code === 'auth/wrong-password') {
        setError('El correo o la contraseña son incorrectos.');
      } else if (err.code === 'auth/too-many-requests') {
        setError('Cuenta bloqueada temporalmente por demasiados intentos. Intenta más tarde o restablece tu contraseña.');
      } else {
  ...
  const handleGoogleLogin = async () => {
    // ... tu código de Google Login no necesita cambios ...
  };
  
  // ==================================================================
  // INICIO DE CAMBIOS: Nueva función para restablecer contraseña
  // ==================================================================
  const handlePasswordReset = async () => {
    if (!email) {
      setError("Por favor, ingresa tu correo electrónico en el campo de arriba y luego haz clic aquí.");
      return;
    }
    setError('');
    setMessage('');
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-xl shadow-2xl">
        ...
        <div className="text-center text-sm">
          {/* ================================================================== */}
          {/* INICIO DE CAMBIOS: Enlace para restablecer contraseña */}
          {/* ================================================================== */}
