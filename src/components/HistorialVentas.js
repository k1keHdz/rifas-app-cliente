                ...
                <table className="min-w-full text-left">
                    <thead className="bg-background-dark">
                        <tr>
                            ...
                            {/* ================================================================================================= */}
                            {/* INICIO DE LA MODIFICACIÓN: Se añade la cabecera para la columna 'Estado'                        */}
                            {/* ================================================================================================= */}
                        ...
                        {ventasFiltradas.map((venta) => {
                            ...
                            return (
                                <tr key={venta.id} className="hover:bg-border-color/20 text-sm">
                                    ...
                                    {/* ================================================================================================= */}
                                    {/* INICIO DE LA MODIFICACIÓN: Se añade la celda para mostrar el estado de residencia           */}
                                    {/* ================================================================================================= */}
                                    <td className="px-4 py-2 align-top">
                                        <p className="font-medium">{venta.comprador?.estado || 'N/A'}</p>
                                    </td>
                                    {/* ================================================================================================= */}
                                    {/* FIN DE LA MODIFICACIÓN                                                                          */}
                                    {/* ================================================================================================= */}
                    ...
                    {mostrarTotal && (
                        <tfoot>
                            <tr className="bg-background-dark font-bold">
                                {/* =============================================================================================== */}
                                {/* INICIO DE LA MODIFICACIÓN: Se corrige el colSpan para alinear el total                       */}
                                {/* =============================================================================================== */}
