      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <h3 className="text-lg font-bold">Sorteos App</h3>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><Link to="/" className="text-base text-gray-300 hover:text-white">Inicio</Link></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p className="text-base text-gray-400">&copy; 2025 Sorteos App. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
