...
// ==================================================================
// INICIO DE CAMBIOS: Nuevo ícono para Ganadores
// ==================================================================
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* ================================================================== */}
        {/* INICIO DE CAMBIOS: Añadimos la nueva tarjeta y ajustamos el grid */}
        {/* ================================================================== */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link to="/admin/gestionar-rifas" className="block p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="mt-2 text-gray-600">Crea, edita y revisa los detalles de todas tus rifas.</p>
          </Link>
          ...
          <Link to="/admin/historial-ventas" className="block p-8 bg-white rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <p className="mt-2 text-gray-600">Consulta el historial detallado de ventas por cada rifa.</p>
          </Link>
