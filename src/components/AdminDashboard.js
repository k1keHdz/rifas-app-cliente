...
// =================================================================================================
// INICIO DE LA MODIFICACIÓN: Se importa el nuevo componente del formulario.
// =================================================================================================
        ...
        <div className="bg-background-dark min-h-screen p-4 sm:p-8">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <Link to="/admin/clientes" className="block p-8 bg-background-light rounded-xl shadow-lg hover:shadow-2xl hover:shadow-purple-500/20 hover:-translate-y-1 transition-all duration-300 border border-border-color hover:border-purple-500/50 text-purple-500">
                        <ClientesIcon />
                        <h2 className="mt-4 text-2xl font-bold text-text-primary">Base de Datos de Clientes</h2>
                        <p className="mt-2 text-text-subtle">Consulta y exporta la información de todos tus participantes.</p>
                    </Link>
                ...
                {/* =============================================================================================== */}
                {/* INICIO DE LA MODIFICACIÓN: Se integra el nuevo componente AddAdminForm                      */}
                {/* =============================================================================================== */}
                <div className="mt-12">
                   <AddAdminForm />
                </div>
