...
function GestionarRifasPage() {
  ...
  const handleDeleteRifa = async (rifaId, nombreRifa) => {
    // NOTA: window.confirm() es una mala práctica en apps modernas.
    // Debería ser reemplazado por un componente de Modal de confirmación para una mejor UX.
    ...
    <div className="bg-background-dark p-4 max-w-7xl mx-auto relative min-h-screen">
      ...
      <div className="border-b border-border-color mb-6 mt-4">
        <nav className="-mb-px flex space-x-6" aria-label="Tabs">
          {/* REPARACIÓN: Se eliminan las clases de color de texto. El estado activo lo controla el borde y el color de texto del tema. */}
